<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/HomeMaster.master" AutoEventWireup="true" CodeFile="AccJournalVoucher.aspx.cs" Inherits="Forms_AccJurnalVoucher" %>
     ...
     <div class="container">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <p class="label-info" style="text-align: center; font-weight: bold; font-size: 20px; height: 30px; color: white; margin-top: 0.2rem">Journal Voucher Entry Window </p>
            </div>
            <div class="col-sm-2">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <%--<table>
                                <tr>
                                    <td>
                                        <asp:DropDownList runat="server" ID="DropDownList1" CssClass="Select2" Style="width: 260px">
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td>
                                        <asp:DropDownList runat="server" ID="DropDownList2" CssClass="Select2" Style="width: 260px">
                                        </asp:DropDownList>
