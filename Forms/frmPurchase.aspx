<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/HomeMaster.master" AutoEventWireup="true" CodeFile="frmPurchase.aspx.cs" Inherits="Forms_frmPurchase" %>
     ...
     <%-- <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>--%>
      <div class="row">
       <div class="col-sm-6 col-sm-offset-3">
        <p class="label-info" style="text-align:center;font-weight:bold;font-size:20px; height:30px;color:white;margin-top:0.2rem">Received From Supplier </p>
       </div>
       <div class="col-sm-3">
      ...
      <table>
              ...
              <td>
                  <table>
                      ...
                      <tr>
                          ...
                          <td><asp:TextBox runat="server" ID="txtSupplierChallanNo" PlaceHolder="Supplier Challan No" CssClass="form-control"></asp:TextBox></td>
                      </tr>
                      <tr>
                          <td>Supplier Name :</td>
                          <td><asp:DropDownList runat="server" ID="ddlSupplier"  Class="Select2" Style="width: 260px">
                              </asp:DropDownList></td>
                          <td><asp:Button ID="btnPopupSupplier" runat="server" Text="+" CssClass="btn-new btn-default" /></td>
                      </tr>
               ...
               <td>
                    <table>
                        ...
                        <tr>
                          ...
                          <td><asp:TextBox runat="server" ID="txtPurchasePrice"  PlaceHolder="Purchase Price" CssClass="form-control text-align-r" OnTextChanged="txtPurchasePrice_TextChanged" AutoPostBack="true" AutoComplete="off"></asp:TextBox></td>
                      </tr>
       ...
       <asp:Button ID="btnDone" runat="server" Text="Done" CssClass="btn btn-info"  OnClick="btnDone_Click"/>
       <span style="margin-left: 26rem;">Searc By Challan No</span>
       <asp:TextBox ID="txtSearchChallan" runat="server" Style="text-align: center;" PlaceHolder="Challan No" AutoComplete="off"></asp:TextBox>
                        ...
                        <Columns>
                             ...
                             <asp:TemplateField HeaderText="" Visible="false">
                                ...
                                <asp:TemplateField HeaderText="Rate" Visible="true">
                                    ...
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtRateE" runat="server" Text='<%#Bind("rate") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Sales Rate" Visible="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lblSalesRate" runat="server" Text='<%# Bind("ContraRate")%>'></asp:Label>
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <asp:TextBox ID="txtSalesRateE" runat="server" Text='<%#Bind("ContraRate") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                </asp:TemplateField>
        ...
        <div class="col-sm-12">
            <table>
                <tr>
                        ...
                        <table>
                            <tr>
                             ...
                             <tr>
                                <td>Vat :</td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtVat" PlaceHolder="Vat" CssClass="form-control text-align-r" OnTextChanged="txtVat_TextChanged" AutoPostBack="true"></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                <td>Comission :</td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtComission" PlaceHolder="Comission" CssClass="form-control text-align-r" OnTextChanged="txtComission_TextChanged" AutoPostBack="true"></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                <td>Net Amount :</td>
                   ...
                   <table>
                       <tr>
                          <td><asp:Button ID="btnVatComission" runat="server" Text=": :" CssClass=" btn btn-default" OnClick="btnVatComission_Click"/></td>
                   </table>
              </td>
                </tr>
            </table>
