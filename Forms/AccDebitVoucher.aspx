<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/HomeMaster.master" AutoEventWireup="true" CodeFile="AccDebitVoucher.aspx.cs" Inherits="Forms_AccDebitVoucher" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <p class="label-info" style="text-align: center; font-weight: bold; font-size: 20px; height: 30px; color: white; margin-top: 0.2rem">Debit Voucher Entry Window </p>
            </div>
            <div class="col-sm-2">
                    ...
                    <td>
                        <table>
                            ...
                            <tr>
                                <td>Voucher Date :</td>
                                <td>
                                    <asp:TextBox ID="txtVoucherDate" runat="server" placeholder="Select Date" CssClass="voucherDate" Style="width: 260px; height: 30px; margin-top: 0.4rem" autocomplete="off"></asp:TextBox>
         ...
         <asp:Panel ID="pnlSalesGrid" runat="server" CssClass="View_Panel">
                    <asp:GridView ID="gdvVoucherDetails" runat="server" CssClass="mGrid" PagerStyle-CssClass="pgr" 
                        ...
                        <Columns>
                                ...
                                <asp:TemplateField HeaderText="Head Of Accounts" Visible="true">
                                    <ItemTemplate>
                                        <asp:Label ID="lblAccountsHead" runat="server" Text='<%# Bind("AccountsName")%>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
