<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/HomeMaster.master" AutoEventWireup="true" CodeFile="AccCreditVoucher.aspx.cs" Inherits="Forms_AccCreditVoucher" %>
     ...
     <div class="container">
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <p class="label-info" style="text-align: center; font-weight: bold; font-size: 20px; height: 30px; color: white; margin-top: 0.2rem">Credit Voucher Entry Window </p>
            </div>
            <div class="col-sm-2">
            ...
            <table style="margin-left:40%">
                <tr>
                     <td>Total Credit Amount :</td>
                                <td>
                                    <asp:TextBox runat="server" ID="txtNetAmount" PlaceHolder="Total Amount" CssClass="form-control text-align-r" autocomplete="off"></asp:TextBox>
                                </td>
                </tr>
            </table>
        </div>
