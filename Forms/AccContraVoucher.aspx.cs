...
public partial class Forms_AccContraVoucher : System.Web.UI.Page
{
    clsAccountHandler objAccounts = new clsAccountHandler();
    clsServiceHandler objServiceHandler = new clsServiceHandler();
    public static string branchId;
    public static string userId;
    public static string vType = "3";
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
          try
        {
            ...
            string qryString = "SELECT id  FROM accTRANSACTIONLIST WHERE posted=1 and  BRID='" + branchId + "' AND VTYPE=3  AND VNO='" + txtVoucherNo.Text + "'";
