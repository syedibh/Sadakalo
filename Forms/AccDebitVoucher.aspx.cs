...
public partial class Forms_AccDebitVoucher : System.Web.UI.Page
{
    clsAccountHandler objAccounts = new clsAccountHandler();
    clsServiceHandler objServiceHandler = new clsServiceHandler();
    public static string branchId;
    public static string userId;
    public static string vType="1";
    ...
    private void loadgdvVoucherDetails(string voucherNo)
    {
        ...
        {
            string voucherId = objServiceHandler.ReturnString("SELECT ID FROM ACCTRANSACTIONLIST WHERE BRID='" + branchId + "' AND VTYPE='" + vType + "' AND  VNO='" + voucherNo + "'");
            string strSql = " SELECT ROW_NUMBER() over (order by TD.AccTransactionDetails_Id asc) as SL_NO,TD.AccTransactionDetails_Id, TD.Dr_AccChartOfAccounts_Id,TD.Cr_AccChartOfAccounts_Id,AM.AccountsName,TD.Amount,TD.TransactionNote FROM AccTransactionDetails TD,AccChartOfAccountsMaster AM where TD.Dr_AccChartOfAccounts_Id=AM.ID AND  TD.AccTransactionList_Id='" + voucherId + "'";
            DataSet oDs = objServiceHandler.ExecuteQuery(strSql);
    ...
    //private void LoadFooterInfo(string voucherNo)
    //{
    //    string strSql = "";
    //    lblMesseage.Text = "";
    //    string voucherId = "";
    ...
    //                {
    //                    strSql = "SELECT VNO,CustomerId,(SELECT MobileNo FROM CustomerProfile WHERE CustomerId=TL.CustomerId) AS MobileNo, TotalBill,Commission,Vat,AmountPaid,ContraRef,ToBrId FROM TransactionList TL where refNo='" + voucherId + "'";
    ...
    protected void btnPrint_Click(object sender, EventArgs e)
    {
         try
        {
            ...
            string qryString = "SELECT id  FROM accTRANSACTIONLIST WHERE posted=1 and  BRID='" + branchId + "' AND VTYPE=1  AND VNO='" + txtVoucherNo.Text + "'";
